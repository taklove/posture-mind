...
private fun DrawScope.drawChinTuck(p: Float, pulse: Float, cx: Float, cy: Float) {
    ...
    // 躯干（肩膀 + 上背）
    pRoundRect(BODY, Offset(cx - 70, cy + 20), Size(140f, 110f), 16f)
    pRoundRect(BODY_LIGHT, Offset(cx - 70, cy + 20), Size(140f, 30f), 16f)
    // 脖子
    pRoundRect(SKIN, Offset(cx - 18 + dx, cy - 35), Size(36f, 50f), 8f)
    pRoundRect(SKIN_DARK.copy(alpha = 0.15f), Offset(cx - 18 + dx, cy - 35), Size(36f, 50f), 8f)
    // 头
    pCircle(SKIN, 36f, Offset(cx + dx, cy - 80), stroke = SKIN_DARK)
    // 头发
    pPath(SKIN_DARK, Offset(cx - 32 + dx, cy - 100), Size(64f, 30f), 16f)
    // 眼睛
    pCircle(Color.Black, 2f, Offset(cx + 12 + dx, cy - 80))

    // 主训肌群：颈深屈肌（脖子前面）
    pMuscle("颈深屈肌", Offset(cx - 12 + dx, cy - 15), Size(28f, 36f), MUSCLE, pulse)
...
private fun DrawScope.drawHeadLift(p: Float, pulse: Float, cx: Float, cy: Float) {
    ...
    // 仰卧身体（侧视）—— 躯干水平
    pRoundRect(BODY, Offset(cx - 110, cy + 10), Size(220f, 60f), 14f)
    pRoundRect(BODY_LIGHT, Offset(cx - 110, cy + 10), Size(220f, 16f), 14f)
    // 髋
    ...
    // 脖子（侧视）
    pRoundRect(SKIN, Offset(cx - 150, cy - 10 + dy), Size(40f, 50f), 10f)
    // 头
    pCircle(SKIN, 28f, Offset(cx - 165, cy - 25 + dy), stroke = SKIN_DARK)
    // 头发
    pPath(SKIN_DARK, Offset(cx - 180, cy - 50 + dy), Size(40f, 28f), 14f)

    // 主训肌群：颈深屈肌（脖子前面）
    pMuscle("颈深屈肌", Offset(cx - 130, cy - 5 + dy), Size(26f, 32f), MUSCLE, pulse)
}
...
private fun DrawScope.drawProneY(p: Float, pulse: Float, cx: Float, cy: Float) {
    ...
    // 俯卧身体（侧视）—— 头在左
    pRoundRect(BODY, Offset(cx - 120, cy + 30), Size(220f, 50f), 14f)
    // 髋/腿
    ...
    pPath(SKIN_DARK, Offset(cx - 158, cy + 12), Size(36f, 26f), 12f)
    ...
    // 主训肌群：下斜方肌（肩胛之间）
    pMuscle("下斜方肌", Offset(cx - 40, cy + 20), Size(60f, 28f), MUSCLE, pulse)
}
...
private fun DrawScope.drawWallSlide(p: Float, pulse: Float, cx: Float, cy: Float) {
    ...
    pPath(SKIN_DARK, Offset(cx - 86, cy - 125), Size(40f, 28f), 14f)
    // 脖子 + 躯干
    pRoundRect(BODY, Offset(cx - 85, cy - 70), Size(40f, 180f), 12f)
    // 髋
    pRoundRect(BODY, Offset(cx - 90, cy + 90), Size(50f, 30f), 12f)
    // 腿
    ...
    // 主训肌群：下斜方肌（肩胛之间）
    pMuscle("下斜方肌", Offset(cx - 30, cy - 30), Size(50f, 24f), MUSCLE, pulse)
    // 副训：前锯肌（肋侧）
    pMuscle("前锯肌", Offset(cx - 30, cy + 20), Size(40f, 30f), MUSCLE_2, pulse)
}
...
private fun DrawScope.drawScapPushup(p: Float, pulse: Float, cx: Float, cy: Float) {
    ...
    pPath(SKIN_DARK, Offset(cx - 134, cy + 30), Size(28f, 22f), 11f)
    // 前臂撑地
    ...
    // 主训肌群：前锯肌（肋侧，肩胛下方）
    pMuscle("前锯肌", Offset(cx + 10, cy - 5 + dy), Size(50f, 32f), MUSCLE, pulse)
    // 标记圆（肩胛骨）
...
private fun DrawScope.drawBridge(p: Float, pulse: Float, cx: Float, cy: Float, singleLeg: Boolean) {
    ...
    pPath(SKIN_DARK, Offset(cx - 156, cy + 46), Size(34f, 26f), 13f)
    // 肩膀
    pRoundRect(BODY, Offset(cx - 110, cy + 60), Size(40f, 30f), 10f)

    // 躯干（拱起）—— 弧线
    pArc(BODY, Offset(cx - 70, cy - 20 + arch), Size(180f, 100f), 180f, 180f, strokeWidth = 36f)
    // 高光
    pArc(BODY_LIGHT, Offset(cx - 70, cy - 20 + arch), Size(180f, 100f), 180f, 180f, strokeWidth = 12f)
    ...
    // 主训肌群：臀大肌（髋后）
    pMuscle("臀大肌", Offset(cx + 50, cy + 20 + arch), Size(46f, 38f), MUSCLE, pulse)
    // 副训：腘绳肌（大腿后）
    pMuscle("腘绳肌", Offset(cx + 100, cy + 50 + arch / 2), Size(40f, 22f), MUSCLE_2, pulse)
}
...
private fun DrawScope.drawClamshell(p: Float, pulse: Float, cx: Float, cy: Float) {
    ...
    pPath(SKIN_DARK, Offset(cx - 134, cy + 28), Size(30f, 24f), 12f)
    // 躯干（侧躺）—— 横放
    pRoundRect(BODY, Offset(cx - 90, cy + 20), Size(180f, 50f), 14f)
    pRoundRect(BODY_LIGHT, Offset(cx - 90, cy + 20), Size(180f, 14f), 14f)
    // 髋
    ...
    // 主训肌群：臀中肌（髋外侧）
    pMuscle("臀中肌", Offset(cx + 70, cy + 70), Size(34f, 24f), MUSCLE, pulse)
}
...
private fun DrawScope.drawDeadBug(p: Float, pulse: Float, cx: Float, cy: Float) {
    ...
    pPath(SKIN_DARK, Offset(cx - 16, cy - 124), Size(32f, 26f), 12f)
    // 躯干
    pRoundRect(BODY, Offset(cx - 40, cy - 70), Size(80f, 140f), 18f)
    pRoundRect(BODY_LIGHT, Offset(cx - 40, cy - 70), Size(80f, 30f), 18f)
    ...
    // 主训肌群：腹横肌（核心）
    pMuscle("腹横肌", Offset(cx, cy + 5), Size(50f, 50f), MUSCLE, pulse)
    // 副训：多裂肌（腰后）
    pMuscle("多裂肌", Offset(cx, cy + 50), Size(36f, 22f), MUSCLE_2, pulse)
}
...
private fun DrawScope.drawBirdDog(p: Float, pulse: Float, cx: Float, cy: Float) {
    ...
    pPath(SKIN_DARK, Offset(cx - 144, cy + 28), Size(30f, 24f), 12f)
    // 躯干（水平）
    pRoundRect(BODY, Offset(cx - 100, cy + 30), Size(180f, 50f), 14f)
    pRoundRect(BODY_LIGHT, Offset(cx - 100, cy + 30), Size(180f, 14f), 14f)
    ...
    // 主训肌群：腹横肌（核心）
    pMuscle("腹横肌", Offset(cx - 20, cy + 10), Size(48f, 26f), MUSCLE, pulse)
    // 副训 1：多裂肌（腰后）
    pMuscle("多裂肌", Offset(cx + 20, cy + 50), Size(36f, 18f), MUSCLE_2, pulse)
    // 副训 2：臀大肌
    pMuscle("臀大肌", Offset(cx + 60, cy + 70), Size(34f, 20f), MUSCLE_2, pulse)
}
...
private fun DrawScope.drawBreathing(p: Float, pulse: Float, cx: Float, cy: Float) {
    ...
    pPath(SKIN_DARK, Offset(cx - 146, cy + 26), Size(32f, 26f), 12f)
    // 躯干（呼吸胀缩）
    pRoundRect(BODY, Offset(cx - 100, cy + 20), Size(180f, 50 + breath), 16f)
    pRoundRect(BODY_LIGHT, Offset(cx - 100, cy + 20), Size(180f, 16f), 16f)
    // 髋
    ...
    // 主训肌群：膈肌（肋下）
    pMuscle("膈肌", Offset(cx - 30, cy + 5), Size(60f, 22f), MUSCLE, pulse)
    // 副训：腹横肌
    pMuscle("腹横肌", Offset(cx + 30, cy + 40), Size(40f, 28f), MUSCLE_2, pulse)
}
...
private fun DrawScope.drawTke(p: Float, pulse: Float, cx: Float, cy: Float) {
    ...
    pPath(SKIN_DARK, Offset(cx - 46, cy - 124), Size(34f, 26f), 12f)
    pRoundRect(BODY, Offset(cx - 45, cy - 70), Size(40f, 160f), 12f)
    pRoundRect(BODY, Offset(cx - 50, cy + 70), Size(50f, 30f), 12f)
    // 后腿
...
private fun DrawScope.drawShortFoot(p: Float, pulse: Float, cx: Float, cy: Float) {
    ...
    // 小腿（下半截，侧视）
    pRoundRect(BODY, Offset(cx - 30, cy - 60), Size(60f, 100f), 16f)
    pRoundRect(BODY_LIGHT, Offset(cx - 30, cy - 60), Size(60f, 20f), 16f)
    // 脚踝
    pCircle(SKIN, 18f, Offset(cx, cy + 50), stroke = SKIN_DARK)
    // 脚
    pOval(SKIN, Offset(cx - 80, cy + 50), Size(160f, 36f), stroke = SKIN_DARK)
    // 脚趾
...
private fun DrawScope.drawBridgeCurl(p: Float, pulse: Float, cx: Float, cy: Float) {
    ...
    pPath(SKIN_DARK, Offset(cx - 156, cy + 36), Size(34f, 26f), 13f)
    pRoundRect(BODY, Offset(cx - 110, cy + 50), Size(40f, 30f), 10f)
    ...
    // 主训肌群：腘绳肌（大腿后）
    pMuscle("腘绳肌", Offset(cx + 90, cy + 30 + arch / 2), Size(40f, 20f), MUSCLE, pulse)
    // 副训：臀大肌
    pMuscle("臀大肌", Offset(cx + 50, cy + 10 + arch), Size(40f, 28f), MUSCLE_2, pulse)
}
...
private fun DrawScope.drawDefault(p: Float, pulse: Float, cx: Float, cy: Float) {
    ...
    pRoundRect(BODY, Offset(cx - 30, cy - 45), Size(60f, 110f), 16f)
